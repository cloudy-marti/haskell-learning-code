...
, getVars
  ...
  isMonotone c = isNegMonotone c || isPosMonotone c
  -- To be implemented...
  ...
  -- F.all determines whether all elements of the foldable structure satisfy the predicate
  ...
  isNegMonotone = F.all (== True) . L.map Lit.toBool . getLits
  ...
  getVars = L.nub . L.map Lit.getVar . getLits
  -- L.nub will remove duplicates
